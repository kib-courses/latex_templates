...
\logo{\href{https://t.me/kibinfo}{\includegraphics[width=.1\textwidth]{./../pic/kib_logo.png}}}
\author{Максимилиан Максимилианович Робеспьер}
\institute{Москва,\\ \href{https://t.me/kibinfo}{\textbf{КИБ}}}
...
\begin{frame}{Две или три колонки}
...
\begin{frame}{Вопросы для самопроверки \& Список материалов}
	...
	Эти блоки \text{не нужно} включать в план\footnote{См. слайд №\ref{frame:plan}}.
\end{frame}
